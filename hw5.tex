...
\begin{sol}
  Professor: Holmquist-Day  \\ 
  Department: Psychology \\ 
  Do you think you can win?: No I do not. \\ 
  How do you think the "AI" is picking it's moves?: I think it's trying to predict my next move, it's thinking maybe one or two moves ahead.  \\ 
\end{sol}
  
\begin{sol}
  Professor: Cooper \\ 
  Department: English \\ 
  Do you think you can win?: Nope. \\ 
  How do you think the "AI" is picking it's moves?: It follows a pattern. \\ 
\end{sol}
