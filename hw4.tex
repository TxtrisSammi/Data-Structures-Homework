...
\img<img>[0.65]{Append Plot}{./media/List_append.png}
\img<img>[0.65]{Search Plot}{./media/List_search.png}
...
\img<img>[1]{Balanced.java Screenshot}{./media/BalancedScreenshot.png}
\img<img>[0.65]{Sierpinski.java Screenshot}{./media/SierpinskiScreenshot.png}
...
\img<img>[0.65]{Binaryheap.java Screenshot}{./media/BinaryHeapScreenshot.png}
